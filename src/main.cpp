...
int main()
{
    ...
    // generate vertex shader and assign source code
    ...
    // generate fragment shader and assign source code
    ...
    // if successfully linked, use this shader program
    glDeleteShader(vertexShader); // deallocate linked shaders
